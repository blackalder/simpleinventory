                    ...
                    <div class="partition-form">
                        <form autocomplete="false">
                            ...
                            <div class="form-group row" v-for="(item, k) in form.items" :key="k">
                                ...
                                <div class="col-md-5">
                                    <input id="item" type="text" class="form-control" name="qty" v-model="form.items[k].qty" placeholder="Qty">
                                </div>
                                <div class="col-md-2">
                                    <button v-if="k > 0" @click.prevent="remove(k)"><i class="fa fa-trash"></i></button>
                                </div>
                            </div>
